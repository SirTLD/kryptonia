      ...
      <div className='container mx-auto'>
        <div className='flex flex-col items-center lg:flex-row'>
          ...
          <div className='flex-1'>
            {/* logo badge text*/}
            <div
              className='bg-white/10 p-1 mb-6 rounded-full pl-1 pr-3 
             max-w-[365px]'
              data-aos='fade-down'
              data-aos-delay='400'
            >
            ...
            <h1
              ...
              data-aos-delay='500'
            >
              The Most Secure platform for Cryptocurrency investments.
            </h1>
            <p
              ...
              data-aos-delay='600'
            >
              Buy and sell cyptocurrencies, trusted by over 18M wallets with
              over $23 billion in transactions.
            </p>
            <button
